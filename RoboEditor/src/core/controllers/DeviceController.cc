                           ...
                           std::function<void(const drogon::HttpResponsePtr &)> &&callback)
{
    try {
        ...
        std::cout << "Listed " << result.data["count"].asInt() << " devices";
                           ...
                           const std::string                                     &deviceId)
{
    try {
        ...
        std::cout << "Retrieved device info: " << deviceId;
                             ...
                             const std::string                                     &deviceId)
{
    ...
    try {
        ...
        std::cout << "Updated device: " << deviceId;
                             ...
                             const std::string                                     &deviceId)
{
    try {
        ...
        std::cout << "Deleted device: " << deviceId;

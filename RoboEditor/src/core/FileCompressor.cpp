    ...
    bool createTarGz(const QStringList &inputs, const QString &tarGzPath)
    {
        ...
        auto mapToWorkspace = [](const QString &rel, bool isDir, bool isTop) -> QByteArray {
            ...
            if (isTop) {
                ...
                if (isDir)
                    return QFile::encodeName(QStringLiteral("workspace"));
        ...
        std::function<bool(const QString &, const QString &, bool)> addPath =
            ...
            if (info.isDir()) {
                ...
                archive_entry_set_pathname(
                        dirEntry, mapToWorkspace(relPath, /*isDir*/ true, isTop).constData());
            ...
            archive_entry_set_pathname(entry,
                                       mapToWorkspace(relPath, /*isDir*/ false, isTop).constData());

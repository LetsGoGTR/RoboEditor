...
class ComparePage : public QWidget
{
  ...
  private:
    ...
    struct ControllerPathInfo { QString serial; QString detail; };
    ControllerPathInfo extractControllerInfo(const QString &path) const;
    QPair<QString, QString> determineColumnHeaders(const QString &leftPath, const QString &rightPath) const;
};
#endif  // COMPAREPAGE_H
